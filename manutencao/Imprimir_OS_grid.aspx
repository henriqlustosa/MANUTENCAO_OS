<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Imprimir_OS_grid.aspx.cs" Inherits="manutencao_ReceberOS" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="container">
         <h5 class="text-center">Impressão Ordem de Serviço</h5>
          <br />
                    ...
                    <ItemTemplate>
                        <div class="form-inline">
                            <asp:LinkButton ID="lbDadosPaciente" CommandName="remover" CommandArgument='<%#((GridViewRow)Container).RowIndex%>'
                                Class="btn btn-outline-success" runat="server">Imprimir                                                                
                            </asp:LinkButton>
                        </div>
                    </ItemTemplate>
